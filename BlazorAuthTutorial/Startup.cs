...
using BlazorAuthTutorial.Areas.Identity;
using BlazorAuthTutorial.Data;
using BlazorAuthTutorial.Store;
using BlazorAuthTutorial.Stores;
using BlazorAuthTutorial.Stores.CounterStore;

namespace BlazorAuthTutorial
{
